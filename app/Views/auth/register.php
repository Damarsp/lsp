                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form action="<?= route_to('register') ?>" method="post" class='user'>
                                    ...
                                    <div class="form-group">
                                        <select class="form-select form-control form-control-user" aria-label="Default select example" name="id_spp" id="id_spp">
                                            <?php
                                            $db = \Config\Database::connect();
                                            $builder = $db->table('spp');
                                            $query = $builder->get();
                                            $spp = $query->getResultArray();
                                            ?>
                                    ...
                                    <div class="form-group">
                                        <select class="form-select form-control form-control-user" aria-label="Default select example" name="id_kelas" id="id_kelas">
                                            <?php
                                            $db = \Config\Database::connect();
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control" name="alamat" id="alamat" cols="10" rows="5" placeholder="Alamat"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <input type="number" name="no_telp" class="form-control form-control-user" placeholder="No Telp">
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
